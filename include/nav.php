...
function nav(&$a) {
	...
	if($banner === false) 
		$banner .= '<a href="http://zot.friendika.com"><img id="logo-img" src="images/strike-32.png" alt="logo" /></a><span id="logo-text"><a href="http://zot.friendika.com">Zot!</a></span>';
