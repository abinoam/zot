...
$o .= <<< EOT
<div id="advanced-profile_name-wrapper" >
<div id="advanced-profile_name-text">$lbl_fullname</div>
<div id="advanced-profile_name">$fullname</div>
</div>
<div id="advanced-profile_name-end"></div>
EOT;
}
