...
function js_upload_form(&$a,&$b) {
	...
	$b['addon_text'] .= '<link href="' . z_path() . '/addon/js_upload/file-uploader/client/fileuploader.css" rel="stylesheet" type="text/css">';
	$b['addon_text'] .= '<script src="' . z_path() . '/addon/js_upload/file-uploader/client/fileuploader.js" type="text/javascript"></script>';
